...
export default function About() {
  return (
    <>
      ...
      <Section top={false} bottom={false} imgBreak={true}>
        <BannerContainer>
          <BannerImage style={{width: `800px`}} src={beanieBanner} alt='chuck-palahniuk' />
          <ChuckQuote className='quote'>
            <p style={{borderTop: `5px solid rgb(28,30,36)`, borderRight: `5px solid rgb(28,30,36)`, padding: `10px`, borderRadius: `5px`}}>
      ...
      <Section top={false} bottom={false} imgBreak={false}>
        <div style={{width: `68%`, margin: `0 auto`}}>
          ...
          <p>With the trial behind him, Chuck threw himself into his work. 2003 would go down as a banner year, but not many people realize it began with a small literary conference in Edinboro, Pennsylvania. The three-day event gave fans unprecedented access to the author and his work, and was presided over by Chuck himself. The schedule consisted of exclusive readings, Q&As, book signings, dissertations- all devoted to Chuck. Not one to revel in the spotlight, Chuck selflessly used this forum to promote the art of storytelling, and to encourage a generation of young readers to evolve into writers.  The entire affair was thoroughly documented by a crew from ChuckPalahniuk.net in the film, <span style={{color: `rgb(105,128,221)`}}>Postcards From the Future: The Chuck Palahniuk Documentary.</span></p>
          <p>Both Diary and the non-fiction guide to Portland, Fugitives and Refugees, were released later that year. While on the road in support of Diary, Chuck began reading a short story entitled 'Guts,' which would eventually become part of the novel Haunted. 'Guts' instantly became one of Chuck’s most infamous stories, due in large part to the graphic nature of its content- extreme masturbation gone awry- and the fact that it caused people to faint at his readings.</p>
          <p>Over a hundred faintings have been reported, one of the most severe occurring during a reading at Columbia University, where a man fell to the ground and awoke screaming. The incident was caught on tape and is featured in the Postcards From the Future documentary.</p>
          <p>It was also around this time that Chuck publicly came out as homosexual. For a long time it was assumed that Chuck was married, and some members of the press even perpetuated the myth that he had a wife, but he set the record straight via an audio message posted on ChuckPalahniuk.net.</p>
          <p>In the years that followed, things seemed to settle down for Chuck. He continued to write, publishing the bestselling Rant, Snuff, Pygmy, Tell-All, a 'remix' of Invisible Monsters, Damned and most recently, Doomed. To this day, he still attends a weekly workshop with close friends and writers such as Lidia Yuknavitch, Monica Drake, Chelsea Cain and Suzy Vitello, and they are the first people to read anything he writes. Chuck is a vocal proponent of the minimalist writing style, and credits Tom Spanbauer and his mentor, Gordon Lish, as major influences, along with Amy Hempel, Denis Johnson and Bret Easton Ellis.</p>
          <p>In regards to his own writing, Chuck has stated that he writes each chapter of his novels as if they were a short story. He feels every one of his novels should be able to be condensed into a short story and still work.</p>
          <p>Chuck is also known for doing extensive research. He says that research is his favorite part of the writing process and is the fuel that drives his novels. He has been known to consume entire books and distil that information into a single descriptive line. He writes in public, spending hours people-watching as he does. If you have a passing conversation with Chuck on the street, there’s a good chance it ends up in one of his books. According to Chuck,</p>
        </div>
      </Section>
      <Section top={false} bottom={false} imgBreak={true}>
      <BannerContainer>
          <BannerImage style={{height: `400px`}} src={reading} alt='chuck-palahniuk' />
          <ChuckQuote className='quote'>
            <p style={{borderTop: `5px solid rgb(28,30,36)`, borderRight: `5px solid rgb(28,30,36)`, padding: `10px`, borderRadius: `5px`}}>
