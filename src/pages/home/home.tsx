      ...
      <section style={{ margin: `10px auto` }}>
        <CardContainer>
          ...
          <Card imgUrl={tattoo}>
            ...
            <Mark fontSize='1.85rem'>Born February 21, 1962, [Chuck] spent his early childhood living out of a mobile home in Burbank, Washington... <Link to='/chuck'>Read More</Link></Mark>
          </Card>
          <Card imgUrl={shirt}>
