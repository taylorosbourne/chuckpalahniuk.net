    ...
    <>
      <HeadImageContainer>
        <div style={{ animation: `1.5s fadeIn ease-in`, width: `100%`, height: `80vh`, backgroundImage: `url('${bannerPortrait}')`, backgroundSize: `cover`, backgroundPosition: `center`, backgroundRepeat: `no-repeat`, display: `flex`, flexDirection: `column`, justifyContent: `center`, alignItems: `flex-start` }}>
          <Mark fontSize='4rem' mobileFontSize='2rem'>Find out what you're</Mark>
          <Mark fontSize='4rem' mobileFontSize='2rem'>afraid of and go live</Mark>
          <Mark fontSize='4rem' mobileFontSize='2rem'>there.</Mark>
        ...
        <CardContainer>
          <Card imgUrl={books}>
            ...
            <Mark fontSize='1.85rem' mobileFontSize='1.5rem'>
              Chuck's books include fifteen original novels, as well four works of non-fiction, and over a dozen short fiction pieces.
              <a
          ...
          <Card imgUrl={tattoo}>
            ...
            <Mark fontSize='1.85rem' mobileFontSize='1.5rem'>Born February 21, 1962, [Chuck] spent his early childhood living out of a mobile home in Burbank, Washington... <Link to='/chuck'>Read More</Link></Mark>
          </Card>
          <Card imgUrl={shirt}>
            <BannerHeader>Merch</BannerHeader>
            <Mark fontSize='1.85rem' mobileFontSize='1.5rem'>
              Chuck's store includes: shirts, outerwear, accessories and more. Because sometimes you are your fucking khakis.
              <a
