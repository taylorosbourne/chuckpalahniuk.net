          ...
          <Card key={i}>
            ...
            <div style={{ marginLeft: `15px` }}>
              ...
              <div style={{ display: `flex`, justifyContent: `flex-start`, alignItems: `center` }}>
                ...
                {darkHorseLink ? <a style={{ textDecoration: `none` }} href={darkHorseLink} target='_blank' rel="noopener noreferrer" ><Button style={{ background: `rgb(28,30,36)` }}><DarkHorse style={{ fill: `rgb(105,128,221)`, margin: `0 5px` }} /></Button></a> : null}
